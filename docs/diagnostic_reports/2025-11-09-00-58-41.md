...
Working directory:
/home/user/vhdl-forge-3v1-claude
...
Resolved 11 packages in 69ms
   Building forge-tools @ file:///home/user/vhdl-forge-3v1-claude/python/forge_tools
   Building forge-platform @ file:///home/user/vhdl-forge-3v1-claude/python/forge_platform
   Building forge-cocotb @ file:///home/user/vhdl-forge-3v1-claude/python/forge_cocotb
Prepared 3 packages in 971ms
Installed 3 packages in 11ms
 + forge-cocotb==3.0.0 (from file:///home/user/vhdl-forge-3v1-claude/python/forge_cocotb)
 + forge-platform==3.0.0 (from file:///home/user/vhdl-forge-3v1-claude/python/forge_platform)
 + forge-tools==3.0.0 (from file:///home/user/vhdl-forge-3v1-claude/python/forge_tools)
```
...
forge_cocotb:
✅ Imported
Location: /home/user/vhdl-forge-3v1-claude/python/forge_cocotb/forge_cocotb/__init__.py

forge_platform:
✅ Imported
Location: /home/user/vhdl-forge-3v1-claude/python/forge_platform/forge_platform/__init__.py

forge_tools:
✅ Imported
Location: /home/user/vhdl-forge-3v1-claude/python/forge_tools/forge_tools/__init__.py
```
...
❌ Missing source files:
  - /home/user/vhdl-forge-3v1-claude/cocotb_test/forge_lut_pkg_tb_wrapper.vhd
```
